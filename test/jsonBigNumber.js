...
describe('bodyParser.jsonBigNumber()', function () {
  it('should parse JSONBigNumber', function (done) {
  ...
  it('should 400 when invalid content-length', function (done) {
    var jsonParser = bodyParser.jsonBigNumber()
